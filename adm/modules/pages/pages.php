...
include_once(MODEL_DOC_PATH.'/pages/page_function.php');
	...
	class Pages extends Control
	{
		...
		{
			$js = array('jquery','bootstrap.min','all_plugins','elrte.min','pages');
		...
		public function render()
		{
			...
			if($this->action == 'addpage')
			{
				Control::get_page('pages/addpage');
			}
			elseif($this->action == 'managepage')
			{
				Control::get_page('pages/managepage');
			}
